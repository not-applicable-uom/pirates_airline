ALTER PROCEDURE sp_cancel_flight_for_specified_country @country VARCHAR(40)
AS
BEGIN

	SELECT * FROM airport WHERE country = @country;
	...
	IF @@ROWCOUNT > 0 
		BEGIN 
		    ...
		    IF @@ROWCOUNT = 0 
				BEGIN
					PRINT 'There is no flight scheduled for ' + @country;
				END				
		END
	ELSE
