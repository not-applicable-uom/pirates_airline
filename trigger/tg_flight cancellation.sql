...
--If a flight is deleted.
	IF @@ROWCOUNT > 0 
		BEGIN
			...
			DECLARE @booking_id INTEGER,@date DATE,@seat_number INTEGER,@passenger_id INTEGER;
			...
			BEGIN
				...
				INSERT INTO booking_refund VALUES(@booking_id, @date, @seat_number, @passenger_id, @flight_id);
